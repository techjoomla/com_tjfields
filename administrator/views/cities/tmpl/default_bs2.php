		...
		<?php if (JVERSION < '3.0'): ?>
			<div id="filter-bar" class="btn-toolbar">
				<div class="filter-search btn-group pull-left">
					...
					placeholder="<?php echo Text::_('COM_TJFIELDS_FILTER_SEARCH_DESC_CITIES'); ?>"
					value="<?php echo $this->escape($this->state->get('filter.search')); ?>"
					class="hasTooltip"
					title="<?php echo Text::_('COM_TJFIELDS_FILTER_SEARCH_DESC_CITIES'); ?>" />
				</div>
				...
				<div class="filter-select fltrt hidden-phone pull right">
					<?php if (JVERSION < '3.0') :
						...
						echo HTMLHelper::_('select.genericlist', $this->regions, "filter_region", 'class="" size="1" onchange="document.adminForm.submit();" name="filter_region"', "value", "text", $this->state->get('filter.region'));
